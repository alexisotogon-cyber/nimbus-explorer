/**
 * Official cloud provider brand marks, inlined as SVG.
 * Paths sourced from Simple Icons (AWS, Google Cloud) and Devicon (Azure) —
 * not hand-drawn, to keep brand shapes accurate.
 */
...
export function AwsLogo({ className = "w-8 h-8" }: LogoProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-label="Amazon Web Services" role="img">
      <path
        fill="#FF9900"
...
export function AzureLogo({ className = "w-8 h-8" }: LogoProps) {
  return (
    <svg viewBox="0 0 128 128" className={className} aria-label="Microsoft Azure" role="img">
      <defs>
        <linearGradient id="azlg-a" x1="60.919" y1="9.602" x2="18.667" y2="134.423" gradientUnits="userSpaceOnUse">
          <stop stopColor="#114A8B" />
          <stop offset="1" stopColor="#0669BC" />
        </linearGradient>
        <linearGradient id="azlg-b" x1="74.117" y1="67.772" x2="64.344" y2="71.076" gradientUnits="userSpaceOnUse">
          <stop stopOpacity=".3" />
        ...
        <linearGradient id="azlg-c" x1="68.742" y1="5.961" x2="115.122" y2="129.525" gradientUnits="userSpaceOnUse">
...
export function GcpLogo({ className = "w-8 h-8" }: LogoProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-label="Google Cloud" role="img">
      <path
        fill="#4285F4"
